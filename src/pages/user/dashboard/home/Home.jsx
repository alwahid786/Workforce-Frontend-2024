  ...
  return (
    <>
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 2xl:gap-6 mt-12 lg:mt-[30px]">
        <HomeCard title='WORKFORCE HIRE' value='60' valuePercentage='1.3' bgImg={workforceGrad} />
        <HomeCard title='PROJECT STAFFED' value='82' valuePercentage='3.3' bgImg={projectGrad} />
        <HomeCard title='AVERAGE DAYS TO PLACEMENT' value='12' valuePercentage='0.3' bgImg={placementGrad} />
        <HomeCard title='AVERAGE DAYS IDLE' value='234' valuePercentage='4.3' bgImg={averagedaysGrad} />
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-4 md:gap-6 mt-4 md:mt-[40px]">
          <div className="bg-white rounded-[12px] p-4 lg:p-6 xl:p-8">
          ...
          <div className="bg-white rounded-[12px] p-4 lg:p-6 xl:p-8">2</div>
      </div>
    </>
  )
}
